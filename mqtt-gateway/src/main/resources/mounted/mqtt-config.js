...
const BrokerSettings = ({ config, onConfigSaved }) => {
    ...
    return (react_js_default().createElement("div", { className: "broker-settings" },
        react_js_default().createElement("form", { onSubmit: handleSave },
            react_js_default().createElement("div", { className: "form-section" },
                react_js_default().createElement("h2", null, "Connection Settings"),
                react_js_default().createElement("div", { className: "form-group" },
                    react_js_default().createElement("label", { htmlFor: "brokerUrl" }, "Broker URL"),
                    react_js_default().createElement("input", { type: "text", id: "brokerUrl", name: "brokerUrl", value: formData.brokerUrl, onChange: handleChange, placeholder: "tcp://localhost:1883", required: true }),
                ...
                react_js_default().createElement("div", { className: "form-group" },
                    ...
                    react_js_default().createElement("input", { type: "text", id: "clientId", name: "clientId", value: formData.clientId, onChange: handleChange, placeholder: "ignition-mqtt-publisher", required: true })),
                react_js_default().createElement("div", { className: "form-row" },
                    react_js_default().createElement("div", { className: "form-group" },
                        ...
                        react_js_default().createElement("input", { type: "text", id: "username", name: "username", value: formData.username || '', onChange: handleChange, placeholder: "Leave empty for anonymous" })),
                    react_js_default().createElement("div", { className: "form-group" },
                        react_js_default().createElement("label", { htmlFor: "password" }, "Password (optional)"),
                        react_js_default().createElement("input", { type: "password", id: "password", name: "password", value: formData.password || '', onChange: handleChange, placeholder: "Leave empty for no password" })))),
            react_js_default().createElement("div", { className: "form-section" },
                react_js_default().createElement("h2", null, "MQTT Settings"),
                react_js_default().createElement("div", { className: "form-row" },
                    react_js_default().createElement("div", { className: "form-group" },
                        react_js_default().createElement("label", { htmlFor: "qos" }, "Quality of Service (QoS)"),
                        react_js_default().createElement("select", { id: "qos", name: "qos", value: formData.qos, onChange: handleChange },
                    ...
                    react_js_default().createElement("div", { className: "form-group" },
                        ...
                        react_js_default().createElement("input", { type: "number", id: "connectionTimeout", name: "connectionTimeout", value: formData.connectionTimeout, onChange: handleChange, min: 5, max: 300 })),
                    react_js_default().createElement("div", { className: "form-group" },
                        react_js_default().createElement("label", { htmlFor: "keepAliveInterval" }, "Keep Alive Interval (seconds)"),
                        react_js_default().createElement("input", { type: "number", id: "keepAliveInterval", name: "keepAliveInterval", value: formData.keepAliveInterval, onChange: handleChange, min: 10, max: 3600 }))),
                react_js_default().createElement("div", { className: "form-row" },
                    react_js_default().createElement("div", { className: "form-group checkbox" },
                        react_js_default().createElement("label", null,
                            react_js_default().createElement("input", { type: "checkbox", name: "useTls", checked: formData.useTls, onChange: handleChange }),
                            "Use TLS/SSL encryption")),
                    react_js_default().createElement("div", { className: "form-group checkbox" },
                        react_js_default().createElement("label", null,
                            react_js_default().createElement("input", { type: "checkbox", name: "retained", checked: formData.retained, onChange: handleChange }),
                            "Retain messages on broker")),
                    react_js_default().createElement("div", { className: "form-group checkbox" },
                        react_js_default().createElement("label", null,
                            react_js_default().createElement("input", { type: "checkbox", name: "cleanSession", checked: formData.cleanSession, onChange: handleChange }),
            ...
            react_js_default().createElement("div", { className: "form-actions" },
                ...
                react_js_default().createElement("button", { type: "submit", disabled: saving || testing, className: "btn-primary" }, saving ? 'Saving...' : 'Save Configuration')))));
};
        ...
        react_js_default().createElement("form", { onSubmit: handleSave },
            react_js_default().createElement("div", { className: "form-section" },
                ...
                react_js_default().createElement("p", { className: "section-description" },
                    "Map tag providers or folders to custom UNS topic prefixes. Only tags matching enabled mappings will be published to MQTT. Example: Map ",
                ...
                react_js_default().createElement("div", { className: "form-group" },
                    react_js_default().createElement("label", null, "Topic Mappings"),
                    react_js_default().createElement("div", { className: "mapping-input" },
                    ...
                    formData.topicMappings.length > 0 ? (react_js_default().createElement("div", { className: "mappings-list" }, formData.topicMappings.map(mapping => (react_js_default().createElement("div", { key: mapping.id, className: `mapping-item ${!mapping.enabled ? 'disabled' : ''}` },
                        ...
                        react_js_default().createElement("div", { className: "mapping-actions" },
                            ...
                            react_js_default().createElement("button", { type: "button", onClick: () => removeTopicMapping(mapping.id), className: "btn-remove-small" }, "\u2715"))))))) : (react_js_default().createElement("p", { className: "no-mappings" },
                        "No custom topic mappings. Tags will use default mapping: ",
                        react_js_default().createElement("code", null, "[provider]/folder/tag"))),
...
const StatusDashboard = () => {
    ...
    return (react_js_default().createElement("div", { className: "status-dashboard" },
        ...
        react_js_default().createElement("div", { className: "status-grid" },
            ...
            react_js_default().createElement("div", { className: "status-card" },
                react_js_default().createElement("h3", null, "MQTT Connection"),
                react_js_default().createElement("div", { className: "status-content" },
                    ...
                    status.brokerUrl && react_js_default().createElement("p", { className: "broker-url" }, status.brokerUrl),
                    status.reconnectAttempts !== undefined && status.reconnectAttempts > 0 && (react_js_default().createElement("p", { className: "reconnect-info" },
                        "Reconnect attempts: ",
...
const Configuration = () => {
    ...
    const [brokerConfig, setBrokerConfig] = (0,react_js_.useState)(null);
    ...
    return (react_js_default().createElement("div", { className: "mqtt-config-page" },
        react_js_default().createElement("header", { className: "page-header" },
            ...
            react_js_default().createElement("p", { className: "page-description" }, "Configure MQTT broker connection and tag publishing settings")),
        ...
        react_js_default().createElement("div", { className: "tab-content" },
            activeTab === 'broker' && (react_js_default().createElement(components_BrokerSettings, { config: brokerConfig, onConfigSaved: handleBrokerConfigSaved })),
