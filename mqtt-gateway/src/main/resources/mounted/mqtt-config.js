    ...
    return (react_js_default().createElement("div", { className: "tag-selection" },
        react_js_default().createElement("form", { onSubmit: handleSave },
            ...
            react_js_default().createElement("div", { className: "form-section" },
                ...
                react_js_default().createElement("div", { className: "form-group" },
                    react_js_default().createElement("label", null, "Payload Fields"),
                    ...
                    react_js_default().createElement("div", { className: "payload-core" },
                        react_js_default().createElement("div", { className: "payload-core-row" },
                            ...
                            react_js_default().createElement("div", { className: "payload-radio-group" },
                                react_js_default().createElement("label", null,
                                    react_js_default().createElement("input", { type: "radio", name: "includeQuality", checked: payloadFields.includeQuality, onChange: () => updatePayloadCoreField('includeQuality', true) }),
                                    "Include"),
                                react_js_default().createElement("label", null,
                                    react_js_default().createElement("input", { type: "radio", name: "includeQuality", checked: !payloadFields.includeQuality, onChange: () => updatePayloadCoreField('includeQuality', false) }),
                                    "Exclude"))),
                        react_js_default().createElement("div", { className: "payload-core-row" },
                            react_js_default().createElement("span", null, "Quality Code"),
                            react_js_default().createElement("div", { className: "payload-radio-group" },
                                react_js_default().createElement("label", null,
                                    react_js_default().createElement("input", { type: "radio", name: "includeQualityCode", checked: payloadFields.includeQualityCode, onChange: () => updatePayloadCoreField('includeQualityCode', true) }),
                                    "Include"),
                                react_js_default().createElement("label", null,
                                    react_js_default().createElement("input", { type: "radio", name: "includeQualityCode", checked: !payloadFields.includeQualityCode, onChange: () => updatePayloadCoreField('includeQualityCode', false) }),
                                    "Exclude"))),
                        react_js_default().createElement("div", { className: "payload-core-row" },
                            react_js_default().createElement("span", null, "Tag Path"),
                            react_js_default().createElement("div", { className: "payload-radio-group" },
                                react_js_default().createElement("label", null,
                                    react_js_default().createElement("input", { type: "radio", name: "includeTagPath", checked: payloadFields.includeTagPath, onChange: () => updatePayloadCoreField('includeTagPath', true) }),
                                    "Include"),
                                react_js_default().createElement("label", null,
                                    react_js_default().createElement("input", { type: "radio", name: "includeTagPath", checked: !payloadFields.includeTagPath, onChange: () => updatePayloadCoreField('includeTagPath', false) }),
                                    "Exclude")))),
                    react_js_default().createElement("div", { className: "payload-properties" }, payloadPropertyGroups.map(group => (react_js_default().createElement("div", { key: group.id, className: "payload-group" },
                        react_js_default().createElement("h3", null, group.label),
                        react_js_default().createElement("div", { className: "payload-group-fields" }, group.fields.map(field => {
                            ...
                            return (react_js_default().createElement("div", { key: field.key, className: "payload-property-row" },
                                react_js_default().createElement("span", null, field.label),
                                react_js_default().createElement("div", { className: "payload-radio-group" },
                                    react_js_default().createElement("label", null,
                                        react_js_default().createElement("input", { type: "radio", name: `payload-${field.key}`, checked: enabled, onChange: () => updatePayloadField(field.key, true) }),
                                        "Include"),
                                    react_js_default().createElement("label", null,
                                        react_js_default().createElement("input", { type: "radio", name: `payload-${field.key}`, checked: !enabled, onChange: () => updatePayloadField(field.key, false) }),
                                        "Exclude"))));
                        }))))))),
                react_js_default().createElement("div", { className: "form-group checkbox" },
                    react_js_default().createElement("label", null,
