...
const TagSelection = ({ config, onConfigSaved }) => {
    ...
    const getPayloadSummary = (fields) => {
        const coreFields = [
    ...
    const renderMappingItem = (mapping) => {
        ...
        return (react_js_default().createElement("div", { key: mappingId, className: `mapping-item ${!mapping.enabled ? 'disabled' : ''}` },
            react_js_default().createElement("div", { className: "mapping-main" },
                ...
                react_js_default().createElement("div", { className: "mapping-meta" },
                    react_js_default().createElement("span", null, mappingSummary),
                    react_js_default().createElement("span", null, payloadSummary),
                    preserveTopicCase && react_js_default().createElement("span", null, "Preserves case"))),
            ...
            react_js_default().createElement("details", { className: "mapping-advanced" },
                react_js_default().createElement("summary", { className: "mapping-advanced-summary" }, "Route options"),
                ...
                react_js_default().createElement("details", { className: "mapping-payload" },
                    react_js_default().createElement("summary", { className: "mapping-payload-summary" }, "Payload override"),
        ...
        react_js_default().createElement("form", { onSubmit: handleSave },
            react_js_default().createElement("div", { className: "form-section" },
                ...
                react_js_default().createElement("p", { className: "section-description" },
                    "Map tag providers or folders to custom UNS topic prefixes and assign them to MQTT brokers. Each enabled mapping is an independent publish route, so a tag that matches multiple mappings is published through each route. Example: Map ",
                ...
                brokers.length === 0 ? (react_js_default().createElement("div", { className: "warning-message" },
                    ...
                    react_js_default().createElement("small", null, "Each enabled mapping is evaluated as a publish route for matching tags.")))),
            react_js_default().createElement("div", { className: "form-section" },
                ...
                react_js_default().createElement("details", { className: "advanced-settings" },
                    react_js_default().createElement("summary", { className: "advanced-settings-summary" }, "Default payload fields"),
                    react_js_default().createElement("div", { className: "advanced-settings-body" },
                        react_js_default().createElement("p", { className: "advanced-settings-note" }, getPayloadSummary(payloadFields)),
