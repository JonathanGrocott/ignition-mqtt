                        ...
                        react_js_default().createElement("div", { className: "payload-core-row" },
                            ...
                            react_js_default().createElement("div", { className: "payload-radio-group" },
                                ...
                                react_js_default().createElement("label", null,
                                    ...
                                    "Exclude")))),
                    react_js_default().createElement("div", { className: "payload-properties" }, payloadPropertyGroups.map(group => (react_js_default().createElement("details", { key: group.id, className: "payload-group", open: group.id === 'basic' },
